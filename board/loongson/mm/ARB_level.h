...
#define WRLVL_DELAY_MINUS_VALUE (0x30)
#define WRLVL_DELAY_ADD_VALUE   (0x50)
#define WRLVL_DQ_SMALL_DLY      (0x1e)
#define WRLVL_DQ_DEFAULT_DLY    (0x24)
#ifdef  DDR3_SODIMM
#define WRLVL_DDR3_UDIMM_DEFAULT_OFFSET (0x100c0400100c0400)  //for DDR3 SODIMM 1R-x8
#else
#ifdef  DDR3_SMT
#define WRLVL_DDR3_UDIMM_DEFAULT_OFFSET (0x12120c0c06060000)  //for DDR3 SMT
#else
#define WRLVL_DDR3_UDIMM_DEFAULT_OFFSET (0x6052463c2c1e1000)  //for DDR3 UDIMM
#endif
#endif
//using when wrlvl fail
#ifdef  DDR3_DIMM
#define WRLVL_DEFAULT_VALUE     (0x5a5a545044403a34)
#else
#define WRLVL_DEFAULT_VALUE     (0x2020202020202020)
#endif
//for skip wrlvl use
#define WRLVL_DDR3_UDIMM_DEFAULT_VALUE  (0x5a5a545044403a34)    //for DDR3 UDIMM
