...
#define HT1LO_PCICFG_BASE      (int)0xb6800000
#define HT1LO_PCICFG_BASE_TP1  (int)0xb6800000
...
MYDBG
		...
		/*pcie0 is ep*/
		if (device == 0 && *(volatile *)0xbfe10120 & (1<<6))
			goto nodev;
		/*pcie0 is ep*/
		if (device == 1 && *(volatile *)0xbfe10120 & (1<<11))
			goto nodev;
