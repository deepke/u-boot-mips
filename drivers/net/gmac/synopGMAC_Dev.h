...
//#define TRANSMIT_DESC_SIZE  128 //48	//Tx Descriptors needed in the Descriptor pool/queue
#//define RECEIVE_DESC_SIZE   128 //96	//Rx Descriptors needed in the Descriptor pool/queue
