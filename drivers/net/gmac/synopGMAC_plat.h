...
#define CACHED_TO_PHYS(x)       ((int)(x) & 0x7fffffff)
#define PHYS_TO_CACHED(x)       ((int)(x) | CACHED_MEMORY_ADDR)
#define UNCACHED_TO_PHYS(x)     ((int)(x) & 0x1fffffff)
#define PHYS_TO_UNCACHED(x)     ((int)(x) | UNCACHED_MEMORY_ADDR)
#define VA_TO_CINDEX(x)         ((int)(x) & 0xffffff | CACHED_MEMORY_ADDR)
 ...
 * \return  void 
 */
static void synopGMACSetBits(ulong RegBase, u32 RegOffset, u32 BitPos)
{
  //ulong addr = (ulong)RegBase + (ulong)RegOffset;
  u32 data;
 ...
 * \return  void 
 */
static void  synopGMACClearBits(ulong RegBase, u32 RegOffset, u32 BitPos)
{
  u32 data;
  data = synopGMACReadReg(RegBase, RegOffset);
  data &= (~BitPos); 
 ...
 * 
 */
static bool  synopGMACCheckBits(ulong RegBase, u32 RegOffset, u32 BitPos)
{
